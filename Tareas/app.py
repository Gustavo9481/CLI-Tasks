...
def main(message: str) -> None:
    ...
    def clear_screen() -> None:
        """
        Ejecuta comando -clear- en la terminal para limpiar la pantalla
        dependencias: módulo subprocess | run()
    ...
    def menu_new_task(db_connect: sqlite3.Connection, message: str) -> None:
        ...
        dependencias: módulo database.py | new_task(), message
    ...
    def menu_checked_unchecked(db_connect: sqlite3.Connection, message: str) -> None:
        ...
        id: str = input("n° de tarea a cambiar status: ")
    ...
    def menu_edit_task(db_connect: sqlite3.Connection, message: str) -> None:
        ...
        print("editar tarea =>")
        id: str = input("n° de tarea a editar: ")
    ...
    def menu_delete_task(db_connect: sqlite3.Connection, message: str) -> None:
        ...
        id: str = input("n° id de tarea a eliminar: ")
        delete_task(id)
        clear_screen()
